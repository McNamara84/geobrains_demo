...
$isXmlExport = isset($_GET['export']) && $_GET['export'] == 'xml';
...
if ($isXmlExport) {
    // TODO: Datenbankabfrage für ausgewählten Datensatz
    //$data = mysqli_fetch_all($result, MYSQLI_ASSOC);
    exportAsXML(1);
    exit;
}
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <a href="resource-create.php" class="btn btn-success float-right">
                            <?php translate('Add New Record') ?>
                        </a>
                        <a href="resource-index.php?export=xml" class="btn btn-primary float-right mr-2">
                            <?php translate('Export as XML') ?>
                        </a>
                                ...
                                <table class='table table-bordered table-striped'>
                                    ...
                                    <tbody>
                                        <?php while ($row = mysqli_fetch_array($result)): ?>
                                            <tr>
                                                <td>
                                                    <input type="radio" name="resource_id[]" value="<?php echo $row['resource_id']; ?>">
                                                </td>
                                                <?php echo "<td>";
                                                ...
                                                <td>
                                                    ...
                                                    if (!empty($column_id)): ?>
                                                        <a id='read-<?php echo $row['resource_id']; ?>'
                                                            href='resource-read.php?resource_id=<?php echo $row['resource_id']; ?>'
                                                            title='<?php echo addslashes(translate('View Record', false)); ?>'
                                                            data-toggle='tooltip' class='btn btn-sm btn-info'><i
                                                                class='far fa-eye'></i></a>
                                                        <a id='update-<?php echo $row['resource_id']; ?>'
                                                            href='resource-update.php?resource_id=<?php echo $row['resource_id']; ?>'
                                                            title='<?php echo addslashes(translate('Update Record', false)); ?>'
                                                            data-toggle='tooltip' class='btn btn-sm btn-warning'><i
                                                                class='far fa-edit'></i></a>
                                                        <a id='delete-<?php echo $row['resource_id']; ?>'
                                                            href='resource-delete.php?resource_id=<?php echo $row['resource_id']; ?>'
