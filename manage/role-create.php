...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if (!in_array(true, array_column($upload_results, 'error'))) {
        ...
        $stmt = $link->prepare("INSERT INTO `role` (`name`, `description`) VALUES (?, ?)");
        ...
        if (!isset($error)){
            ...
            header("location: role-read.php?role_id=$new_id");
        } else {
            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <a href="role-index.php" class="btn btn-secondary"><?php translate('Cancel') ?></a>
                    </form>
