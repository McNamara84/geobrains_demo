...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if (!in_array(true, array_column($upload_results, 'error'))) {
        ...
        $stmt = $link->prepare("INSERT INTO `licence` (`text`, `code`, `url`) VALUES (?, ?, ?)");

        try {
            $stmt->execute([ $text, $code, $url ]);
        } catch (Exception $e) {
        ...
        if (!isset($error)){
            ...
            header("location: licence-read.php?licence_id=$new_id");
        } else {
            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <a href="licence-index.php" class="btn btn-secondary"><?php translate('Cancel') ?></a>
                    </form>
