...
if(isset($_POST["author_id"]) && !empty($_POST["author_id"])){
    ...
    $fileColumns = [];
    if (isset($tables_and_columns_names['author']['columns'])) {
        foreach ($tables_and_columns_names['author']['columns'] as $columnName => $columnDetails) {
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) . "?author_id=" . $_GET["author_id"]; ?>" method="post">
                    <?php print_error_if_exists(@$error); ?>
                        <div class="alert alert-danger fade-in">
                            <input type="hidden" name="author_id" value="<?php echo trim($_GET["author_id"]); ?>"/>
