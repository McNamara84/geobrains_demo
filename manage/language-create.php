...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if (!in_array(true, array_column($upload_results, 'error'))) {
        ...
        $stmt = $link->prepare("INSERT INTO `language` (`code`, `name`) VALUES (?, ?)");
        ...
        if (!isset($error)){
            ...
            header("location: language-read.php?language_id=$new_id");
        } else {
            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <a href="language-index.php" class="btn btn-secondary"><?php translate('Cancel') ?></a>
                    </form>
