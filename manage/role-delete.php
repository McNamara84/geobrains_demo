...
if(isset($_POST["role_id"]) && !empty($_POST["role_id"])){
    ...
    $fileColumns = [];
    if (isset($tables_and_columns_names['role']['columns'])) {
        foreach ($tables_and_columns_names['role']['columns'] as $columnName => $columnDetails) {
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) . "?role_id=" . $_GET["role_id"]; ?>" method="post">
                    ...
                    <hr>
                    <p>
                        <a href="role-read.php?role_id=<?php echo $_GET["role_id"];?>" class="btn btn-info"><?php translate('View Record') ?></a>
